                ...
                try:
                    ...
                    if success:
                        queue_manager.update_task_status(
                            task_id, queue_manager.TaskStatus.COMPLETED
                        )
                        ...
                        queue_manager.update_task_status(
                            task_id, queue_manager.TaskStatus.FAILED, "传输失败"
                        )
                    ...
                    queue_manager.update_task_status(
                        task_id, queue_manager.TaskStatus.FAILED, str(e)
                    )

                    # 记录错误
                    error_handler.handle_error(
                        e, {"task_id": task_id, "server_id": server_id}
                    )
